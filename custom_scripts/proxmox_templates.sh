...
export ssh_keyfile=/root/scripts/custom_scripts/id_rsa.pub
#Username to create on VM template
export username=kolibri

#Name of your storage
export storage=SSD-POOL
...
create_template 9002 "temp-debian-12-daily" "debian-12-genericcloud-amd64-daily.qcow2" 

## Ubuntu
#20.04 (Focal Fossa)
wget "https://cloud-images.ubuntu.com/releases/focal/release/ubuntu-20.04-server-cloudimg-amd64.img"
create_template 9010 "temp-ubuntu-20-04" "ubuntu-20.04-server-cloudimg-amd64.img" 
#22.04 (Jammy Jellyfish)
wget "https://cloud-images.ubuntu.com/releases/22.04/release/ubuntu-22.04-server-cloudimg-amd64.img"
create_template 9011 "temp-ubuntu-22-04" "ubuntu-22.04-server-cloudimg-amd64.img" 
#23.04 (Lunar Lobster) - daily builds
wget "https://cloud-images.ubuntu.com/lunar/current/lunar-server-cloudimg-amd64.img"
create_template 9012 "temp-ubuntu-23-04-daily" "lunar-server-cloudimg-amd64.img"
...
create_template 9030 "temp-centos-8-stream" "CentOS-Stream-GenericCloud-8-20220913.0.x86_64.qcow2"
...
create_template 9031 "temp-centos-9-stream-daily" "CentOS-Stream-GenericCloud-9-20230123.0.x86_64.qcow2"
